#!/usr/bin/env python3
"""HTTP sidecar for OnnxTR (onnxtr[cpu], ONNX Runtime CPU)."""
...
_port = int(os.getenv("ONNXTR_PORT", "8230"))
_model_id = os.getenv("ONNXTR_MODEL_ID", "onnxtr").strip()
...
app = FastAPI(title="OnnxTR", version="1.0.0", lifespan=lifespan)
