...
**Progress (Wave R):** **#1 Doc OWL** — [issues/doc-owl-wave-r-triage.md](../issues/doc-owl-wave-r-triage.md). **#2 Aya Vision OCR** — [issues/aya-vision-ocr-wave-r-triage.md](../issues/aya-vision-ocr-wave-r-triage.md). **#3 Dolphin** — [issues/dolphin-wave-r-triage.md](../issues/dolphin-wave-r-triage.md). **#4** onward — not started.
